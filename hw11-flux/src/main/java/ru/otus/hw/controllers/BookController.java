...
public class BookController {
    ...
    @GetMapping(value = "/api/book", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<BookDto> findAllBooks() {
        return bookService.findAll();
    }

    @GetMapping(value = "/api/book/{id}", produces = MediaType.APPLICATION_NDJSON_VALUE)
    ...
    @PutMapping(value = "/api/book/{id}", produces = MediaType.APPLICATION_NDJSON_VALUE)
    ...
    @DeleteMapping(value = "/api/book/{id}", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Mono<ResponseEntity<?>> deleteBook(@PathVariable String id) {
        return bookService.deleteById(id)
                .then(Mono.just(new ResponseEntity<>("{}", HttpStatus.OK)));
    }

    @PostMapping(value = "/api/book", produces = MediaType.APPLICATION_NDJSON_VALUE)
