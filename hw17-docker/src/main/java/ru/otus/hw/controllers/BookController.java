...
public class BookController {
    ...
    @PostMapping("/book/{id}")
    public String updateBook(@PathVariable Long id, String title, Long authorId, String genresIds) {
    ...
    @PutMapping("/book/add")
    public String insertBook(String title, Long authorId, String genresIds) {
        var genres = GenreUtils.parseGenres(genresIds);
