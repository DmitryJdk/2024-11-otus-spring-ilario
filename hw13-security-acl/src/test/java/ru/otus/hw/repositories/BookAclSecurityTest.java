...
@DisplayName("Проверка ограничений доступа к репозиторию книг ")
public class BookAclSecurityTest {
    ...
    @DisplayName("должен вернуть все книги, если у пользователя есть права")
    ...
    @DisplayName("должен вернуть все книги, кроме книг, где автор Author_1, если у пользователя нет прав")
