...
import ru.otus.hw.mapper.StockMapper;
import ru.otus.hw.moex.FeignMoexAdapter;
...
public class MoexService {
    ...
    private final FeignMoexAdapter feignMoexAdapter;
    ...
    private List<StockEntity> getStockEntities() {
        try {
            String moexResponse = feignMoexAdapter.getCurrentIndexState();
